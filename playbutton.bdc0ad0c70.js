...
(() => {
  function mount(root) {
    ...
    let x=0,y=0,tx=0,ty=0,vx=0,vy=0,w=0,h=0,size=0,raf=0,last=0,lastEscape=-1000,touchFlight=false;
    ...
    function dodge(px,py,explicit=false,touch=false){
      ...
      // Respect reduced motion; the button still never plays audio.
